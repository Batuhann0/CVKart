...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="list_of_members">
        <div class="sales">
            ...
            <div class="icon-text">
                <h3>
                    <asp:Label ID="lblyetenek" runat="server" Text="Label"></asp:Label></h3>
                <p>Toplam Yetenek</p>
            </div>
        ...
        <div class="new-users">
            ...
            <div class="icon-text">
                <h3>
                    <asp:Label ID="Lblmesaj" runat="server" Text="Label"></asp:Label></h3>
        ...
        <div class="orders">
            ...
            <div class="icon-text">
                <h3>
                    <asp:Label ID="lblderece" runat="server" Text="Label"></asp:Label></h3>
        ...
        <div class="visitors">
            ...
            <div class="icon-text">
                ...
                <p>
                    <asp:Label Style="margin-left: 20px" ID="lblenyüksekyetenek" runat="server" Text="Label"></asp:Label></p>

                <h3>
                    <asp:Label ID="lblenyüksek" runat="server" Text="Label"></asp:Label></h3>

                <p>Yetenek ve En Yüksek Derece</p>
            </div>
            <div class="clearfix"></div>
        </div>
        <div class="clearfix"></div>
